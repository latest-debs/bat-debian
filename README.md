...
[![Release](https://img.shields.io/github/v/release/latest-debs/bat-debian)](https://github.com/latest-debs/bat-debian/releases)
[![Build](https://github.com/latest-debs/bat-debian/actions/workflows/release.yml/badge.svg)](../../actions)

[bat](https://github.com/sharkdp/bat) — A cat(1) clone with wings — packaged for
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/bat-debian/releases) page:

```sh
sudo apt install ./bat_*.deb
```
...
Run the [Build bat for Debian](../../actions) workflow on GitHub with the
...
For issues with bat itself, see
